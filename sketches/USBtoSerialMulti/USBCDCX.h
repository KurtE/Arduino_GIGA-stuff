...
class USBCDCX: public internal::PluggableUSBModule{
public:
    ...
    */
    USBCDCX(bool connect_blocking = true, const char* name = NULL, uint16_t vendor_id = 0x1f00, uint16_t product_id = 0x2012, uint16_t product_release = 0x0001);
    ...
    * @param product_release Your product_release
    */
    USBCDCX(USBPhy *phy, const char* name, uint16_t vendor_id, uint16_t product_id, uint16_t product_release);
