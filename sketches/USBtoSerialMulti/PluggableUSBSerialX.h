...
class USBSerialX: public USBCDCX, public ::mbed::Stream, public HardwareSerial {
public:
    ...
    *
    */
    USBSerialX(bool connect_blocking = true, const char* name = NULL, uint16_t vendor_id = 0x1f00, uint16_t product_id = 0x2012, uint16_t product_release = 0x0001);
    ...
    *
    */
    USBSerialX(USBPhy *phy, uint16_t vendor_id = 0x1f00, uint16_t product_id = 0x2012, uint16_t product_release = 0x0001);
    ...
    */
    ...
    // hacks for multiple instance
    static void waitForPortClose();
    static void waitForPortClose1();

    void processWaitForPortClose();
...
private:
    ...
    // keep object list:
    static uint8_t s_count_objects;
    static USBSerialX *s_objects[MAX_OBJECTS];
    uint8_t object_num;
    //static rtos::EventFlags event[MAX_OBJECTS];
