...
*/
/**************************************************************************/
SDRAMGFXcanvas16::SDRAMGFXcanvas16(uint16_t w, uint16_t h) : Adafruit_GFX(w, h) {
...
*/
/**************************************************************************/
SDRAMGFXcanvas16::~SDRAMGFXcanvas16(void) {
  if (buffer)
    SDRAM.free(buffer);
}
...
*/
/**************************************************************************/
void SDRAMGFXcanvas16::begin() {
    uint32_t bytes = _width * _height * 2;
    Serial.print("\nCanvas::begin(");
    Serial.print(_width, DEC);
    Serial.print(", ");
    Serial.print(_height, DEC);
    Serial.print(" CB:");
    Serial.println(bytes);
    if ((buffer = (uint16_t *)SDRAM.malloc(bytes))) {
      memset(buffer, 0, bytes);
    }
};
...
*/
/**************************************************************************/
void SDRAMGFXcanvas16::drawPixel(int16_t x, int16_t y, uint16_t color) {
  if (buffer) {
...
*/
/**********************************************************************/
uint16_t SDRAMGFXcanvas16::getPixel(int16_t x, int16_t y) const {
  int16_t t;
  switch (rotation) {
  case 1:
    t = x;
...
*/
/**********************************************************************/
uint16_t SDRAMGFXcanvas16::getRawPixel(int16_t x, int16_t y) const {
...
*/
/**************************************************************************/
void SDRAMGFXcanvas16::fillScreen(uint16_t color) {
  if (buffer) {
...
*/
/**************************************************************************/
void SDRAMGFXcanvas16::byteSwap(void) {
  if (buffer) {
    uint32_t i, pixels = WIDTH * HEIGHT;
    for (i = 0; i < pixels; i++)
...
*/
/**************************************************************************/
void SDRAMGFXcanvas16::drawFastVLine(int16_t x, int16_t y, int16_t h,
                                uint16_t color) {
...
*/
/**************************************************************************/
void SDRAMGFXcanvas16::drawFastHLine(int16_t x, int16_t y, int16_t w,
                                uint16_t color) {
...
*/
/**************************************************************************/
void SDRAMGFXcanvas16::drawFastRawVLine(int16_t x, int16_t y, int16_t h,
                                   uint16_t color) {
...
*/
/**************************************************************************/
void SDRAMGFXcanvas16::drawFastRawHLine(int16_t x, int16_t y, int16_t w,
                                   uint16_t color) {
  // x & y already in raw (rotation 0) coordinates, no need to transform.
